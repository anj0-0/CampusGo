...
public class AdminView extends AppCompatActivity {
    ...
    Button registerBtn, loginBtn, updateEmailBtn, deleteUserBtn, logoutBtn, roomAvailabilityBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomAvailabilityBtn = findViewById(R.id.roomAvailability);
        ...
        roomAvailabilityBtn.setOnClickListener(v -> {
            Intent intent = new Intent(AdminView.this, Admin_Room.class);
